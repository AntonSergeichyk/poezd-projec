...
public final class ProjectTestDataImporter {

    private static ProjectTestDataImporter INSTANCE = new ProjectTestDataImporter();
    ...
    public static ProjectTestDataImporter getInstance() {
        return INSTANCE;
    }
}
